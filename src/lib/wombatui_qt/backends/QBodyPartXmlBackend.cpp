...
namespace wombat
{
    ...
    QBodyPartXmlBackend::QBodyPartXmlBackend() : mDomDocument("MyBPL")
    {
    ...
    bool QBodyPartXmlBackend::read(QIODevice *_device)
    {
        QString errorStr;
        int errorLine;
        int errorColumn;
...
//            TRACE("parsing child");
    ...
    bool QBodyPartXmlBackend::write(QIODevice *device)
    {
//        TRACE("writing %i DOM-elements.", mNodeMap.size());
    ...
    void QBodyPartXmlBackend::insertBodyPartNode(BodyPartNode &_node)
    {
    ...
    BodyPartNode QBodyPartXmlBackend::bodyPartNode(unsigned _index) const
    {
        BodyPartNode node;
    ...
    bool QBodyPartXmlBackend::findBodyPartNode(const QString &_name, BodyPartNode &_node) const
    {
    ...
    void QBodyPartXmlBackend::parseBodyPart(const QDomElement &_element)
    {
